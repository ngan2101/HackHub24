  ...
  return (
    <div className="macbook-pro-14-1">
      ...
      <div className="nav-bar">
        ...
        <img className="icround-email-icon" alt="" src="/icroundemail@2x.png" />
      ...
      />
      <img className="icround-search-icon" alt="" src="/icroundsearch@2x.png" />
      ...
      <div className="day-of-the-week-parent">
        ...
        <div className="day-of-the-week">
          ...
          <div className="wrapper">
            <div className="mon">2</div>
          </div>
          <div className="wrapper">
            <div className="mon">3</div>
          </div>
          <div className="wrapper">
            <div className="mon">4</div>
          </div>
          <div className="wrapper1">
            <div className="mon">5</div>
          </div>
          <div className="wrapper">
            <div className="mon">6</div>
          </div>
          <div className="wrapper">
            <div className="mon">7</div>
          </div>
        </div>
        <div className="day-of-the-week">
          <div className="wrapper">
          ...
          <div className="wrapper">
            <div className="mon">10</div>
          </div>
          <div className="wrapper">
            <div className="mon">11</div>
          </div>
          <div className="wrapper">
            <b className="mon">12</b>
          </div>
          <div className="wrapper">
            <div className="mon">13</div>
          </div>
          <div className="wrapper">
            <div className="mon">14</div>
          </div>
        </div>
        <div className="day-of-the-week">
          <div className="wrapper">
            <div className="mon">15</div>
          </div>
          <div className="wrapper">
            <div className="mon">16</div>
          </div>
          <div className="wrapper">
            <div className="mon">17</div>
          </div>
          <div className="wrapper">
            <div className="mon">18</div>
          </div>
          <div className="wrapper">
            <div className="mon">19</div>
          </div>
          <div className="wrapper">
            <div className="mon">20</div>
          </div>
          <div className="wrapper">
            <div className="mon">21</div>
          </div>
        </div>
        <div className="day-of-the-week">
          <div className="wrapper">
            <div className="mon">22</div>
          </div>
          <div className="wrapper">
            <div className="mon">23</div>
          </div>
          <div className="wrapper">
            <div className="mon">24</div>
          </div>
          <div className="wrapper">
            <div className="mon">25</div>
          </div>
          <div className="wrapper">
            <div className="mon">26</div>
          </div>
          <div className="wrapper">
            <div className="mon">27</div>
          </div>
          <div className="wrapper">
            <div className="mon">28</div>
          </div>
        </div>
        <div className="day-of-the-week">
          <div className="wrapper">
          ...
          <div className="wrapper">
            <div className="mon">30</div>
          </div>
          <div className="wrapper">
            <div className="mon">31</div>
          </div>
      ...
      <div className="macbook-pro-14-1-child1" />
      <div className="inbox-overview">INBOX OVERVIEW</div>
      <div className="image-1-wrapper">
        <img className="image-1-icon" alt="" src="/image-1@2x.png" />
      </div>
      <div className="macbook-pro-14-1-child2" />
      <div className="on-going-threads">
        <p className="hi-im-fi">On-going</p>
        <p className="hi-im-fi">threads</p>
      </div>
      <div className="div31">8</div>
      <div className="macbook-pro-14-1-child3" />
      <div className="unread-emails">
        <p className="hi-im-fi">Unread</p>
        <p className="hi-im-fi">emails</p>
      </div>
      <div className="div32">5</div>
      <div className="macbook-pro-14-1-child4" />
      <div className="not-yet-replied-container">
        <p className="hi-im-fi">Not yet</p>
        <p className="hi-im-fi">replied</p>
      </div>
      <div className="div33">15</div>
      <div className="view-all-tasks-wrapper">
        <b className="mon">View all tasks</b>
      </div>
      <div className="view-full-inbox-wrapper">
        <b className="mon">View full inbox</b>
      </div>
      <div className="macbook-pro-14-1-child5" />
      <div className="macbook-pro-14-1-child6" />
      <img className="vector-icon" alt="" src="/vector@2x.png" />
      <div className="macbook-pro-14-1-child7" />
      ...
      <div className="macbook-pro-14-1-child8" />
      <div className="macbook-pro-14-1-child9" />
    </div>
  );
};
